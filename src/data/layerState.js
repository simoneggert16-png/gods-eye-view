...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'battles', token: 'n', disposition: 'enabled-only' }),
  Object.freeze({ id: 'bikeshare', token: 'b', disposition: 'enabled-only' }),
  Object.freeze({ id: 'bombardments', token: 'o', disposition: 'enabled-only' }),
  Object.freeze({ id: 'campaign-trails', token: 'p', disposition: 'enabled-only' }),
  Object.freeze({ id: 'cctv', token: 'c', disposition: 'enabled+options', optionOwner: 'cctv' }),
  Object.freeze({ id: 'conflicts', token: 'k', disposition: 'enabled-only' }),
  Object.freeze({ id: 'drone-attacks', token: 'z', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'frontlines', token: 'l', disposition: 'enabled-only' }),
  Object.freeze({ id: 'live-osint', token: '1', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'military-convoys', token: 'v', disposition: 'enabled-only' }),
  Object.freeze({ id: 'military-installations', token: 'i', disposition: 'enabled-only' }),
  Object.freeze({ id: 'missile-strikes', token: 'j', disposition: 'enabled-only' }),
  Object.freeze({ id: 'missile-tests', token: 'y', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'secret-service', token: 'h', disposition: 'enabled-only' }),
  Object.freeze({ id: 'telegeography-submarine-cables', token: 'u', disposition: 'enabled-only' }),
  Object.freeze({ id: 'terror-attacks', token: '0', disposition: 'enabled-only' }),
