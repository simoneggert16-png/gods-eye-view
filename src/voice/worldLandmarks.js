...
export const WORLD_LANDMARKS = Object.freeze([
  ...
  // ---- Switzerland & Hospitals / Institutions ----------------------------
  {
  ...
  {
    name: 'Kantonsspital St. Gallen (KSSG)',
    lat: 47.4307,
    lon: 9.3873,
    kind: 'building',
    aliases: [
  ...
  {
    name: 'ETH Zürich (Hauptgebäude & Polyterrasse)',
    lat: 47.3764,
    lon: 8.5476,
    kind: 'building',
    aliases: [
  ...
  {
    name: 'Inselspital Bern (Universitätsspital Bern)',
    lat: 46.9479,
    lon: 7.4225,
    kind: 'building',
    aliases: [
  ...
  },
  {
    ...
    lon: 8.5440,
    kind: 'building',
    aliases: ['grossmünster', 'grossmuenster', 'grossmünster zürich'],
  },
  {
    ...
    lon: 7.4442,
    kind: 'building',
    aliases: ['bundeshaus', 'bundeshaus bern', 'palais fédéral'],
  },
]);
