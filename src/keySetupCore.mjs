...
export const KEY_SETUP_KEYS = Object.freeze([
  ...
  Object.freeze({
    id: 'gemini',
    title: 'GEMINI',
    unlocks: 'Live voice dialog + free cloud answers — no billing, free-tier quotas',
    getUrl: 'https://ai.google.dev/gemini-api/docs/api-key',
  ...
  Object.freeze({
    id: 'ollama',
    title: 'OLLAMA',
    unlocks: 'Cloud chat brain for the text box — typed questions, no key in browser',
    getUrl: 'https://ollama.com/settings/keys',
    envVars: Object.freeze(['OLLAMA_API_KEY']),
    tier: 'free',
  }),
  Object.freeze({
    id: 'zai',
    title: 'Z.AI GLM',
    unlocks: 'New + cheap chat brain (GLM-5.3-Flash) for typed questions',
    getUrl: 'https://z.ai/model-api',
    envVars: Object.freeze(['ZAI_API_KEY']),
    tier: 'metered',
  }),
  Object.freeze({
    id: 'aisstream',
